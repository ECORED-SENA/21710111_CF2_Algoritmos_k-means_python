...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-4
      ...
      .col-lg-8.up.my-3
        p(data-aos="fade-down") Muchas veces la validación de los clústeres es lo más difícil en el análisis de los clústeres encontrados; pero es necesario hacerlo usando medidas internas y externas.
        ...
        .row.justify-content-center.text-center         
          .col-lg-6.my-3(data-aos="fade-left")
            .bg18.text-white.p-4.brad.h-100
              ...
              p.mb-0 Es la distancia promedio del centroide a todos los demás puntos en el mismo clúster. 
          .col-lg-6.my-3(data-aos="fade-right")
            .bg18.text-white.p-4.brad.h-100
              ...
              p.mb-0 Distancia promedio del centroide a todos los demás puntos en el clúster cercano.    
    ...
    p(data-aos="fade-down").mb-4 Con el siguiente código se ubica esta muestra tomada y al graficarla se observa en los círculos más grandes los clústeres en donde fueron ubicadas las tres muestras. 
