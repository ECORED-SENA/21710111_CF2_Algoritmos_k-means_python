  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-4         
      .col-lg-4.my-3(data-aos="fade-right")
        p Lo más importante al usar #[i machine learning] de algoritmos supervisados o no supervisados es la interpretación de los resultados. En el caso de la clusterización con #[i k-means] se deben revisar si los #[i clúster] encontrados tienen sentido lógico y cumplen con los objetivos, si un #[i clúster] tiene muy pocos o muchos datos lo más responsable es volver a ejecutar el análisis con otros centroides por ejemplo.
      ...
      .col-lg-4.my-3(data-aos="fade-left")
        .bg14.p-3.j
          p.mb-0 Una variable importante es la distancia euclídea definitiva entre cada punto y su centroide, sus promedios deben tener una variabilidad moderada, si esto no se cumple, lo mejor es repetir el proceso, también es importante medir qué tan separado está un #[i clúster] de otros. 

    .row.justify-content-center.mb-4
      .col-lg-4.up.my-3
        img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/78.png', alt='')        
      .col-lg-8.up.my-3
        p(data-aos="fade-down") Muchas veces la validación de los #[i clúster] es lo más difícil en el análisis de los #[i clúster] encontrados; pero es necesario hacerlo usando medidas internas y externas.
        ...
        .row.justify-content-center.align-items-center         
          .col-lg-12.bg19.p-4
            .row.justify-content-center
              ...
              p(data-aos="fade-down") [0 2 1] es el resultado de cada una de las muestras, las cuales están ubicadas en el #[i clúster] 0, 2 y 1 respectivamente y de acuerdo con los resultados anteriores, el #[i clúster] 0 se refiere a la especie setosa, el #[i clúster] 1 es virginica y el #[i clúster] 2 es versicolor.                                   
      .col-lg-4.up.my-3
        img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/81.png', alt='')  

    p(data-aos="fade-down").mb-4 Con el siguiente código se ubica esta muestra tomada y al graficarla se observa en los círculos más grandes los #[i clúster] en donde fueron ubicadas las tres muestras. 
    .row.justify-content-center.align-items-center.mb-5           
      .col-lg-10.bg20.p-4
        .row.justify-content-center
          ...
          p(data-aos="fade-down") Esto conduce a que el resultado de este código es #[b #[mark.m1 array(&#91;2&#93;),]] lo cual significa que queda ubicada en el #[i clúster] 2, lo cual quiere decir que probablemente esta flor se encuentra clasificada como especie #[b #[mark.m1 versicolor.]]

    p(data-aos="fade-down").mb-4 También se puede predecir en qué #[i clúster] quedaría identificada una flor iris, con datos diferentes a los obtenidos en las muestras anteriores; el proceso que se debe hacer es tal como muestra el código, por ejemplo, se tiene una flor con longitud sépalo = 7, ancho sépalo = 3, longitud de pétalo = 5, ancho de pétalo = 2.           
    ...
    .row.justify-content-center.align-items-center.mb-5           
      .col-lg-10.bg20.p-4
        .row.justify-content-center
          ...
          p(data-aos="fade-down") En resumen #[i k-means] es un método de agrupamiento, con el cual no se debe evaluar la precisión, porque se entrena el modelo con datos de etiquetas de clase y por tanto, puede haber diferencia entre las etiquetas verdaderas y las etiquetas pronosticadas. 

    p(data-aos="fade-down") Es conveniente comparar los gráficos de dispersión originales y con el resultado de #[i k-means] para evaluar el rendimiento de agrupación.                                      
</template>
